...
public class EmployeeList {
	...
	public static void main(String[] args) {
		...
		employeeList.stream().map(Employee::getDepartment) // Extract department names
		...
		Map<String, Double> collect2 = employeeList.stream().distinct().collect(
				Collectors.groupingBy(Employee::getDepartment, Collectors.averagingDouble(Employee::getSalary)));
		Set<Entry<String, Double>> entrySet2 = collect2.entrySet();
		...
		Set<Entry<String, List<Employee>>> entrySet4 = employeeListByDepartment.entrySet();
